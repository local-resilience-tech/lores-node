...
use docker::{
    ...
    docker_stack::{DockerStackServicesResult, docker_stack_ls, docker_stack_services},
};
use service_labels::CoopCloudServiceLabels;
...
fn build_coop_cloud_app(stack: &DockerStack) -> Result<CoopCloudApp, anyhow::Error> {
